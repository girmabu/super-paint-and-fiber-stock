            ...
            ?>
             ...
             <thead>
                <tr>
                  ...
                  <th scope="col">Current balalnce</th>
            ...
            <!-- here you can edit the data of fiber main store -->
             <form action="process.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label> Discription of Item </label>
                            <input type="text" name="item_name" id="item_name" readonly class="form-control" >
                        </div>
                            <input type="hidden" name="item_id" id="item_id" readonly class="form-control" >
              ...
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <!-- This is Edit modal not executed at the background -->
                <button type="submit" name="approve_mininotification" class="btn btn-primary float-right">Send Chanages</button>
              </div>
            </form>
          </div>
       </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Paint Mini Store Raw Material Balance</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php
                $connection = mysqli_connect("localhost","root","");
                $db = mysqli_select_db($connection, 'ssms');
                $sql = "SELECT * FROM paint_mini_item";
                $result=mysqli_query($connection,$sql);
                $num=mysqli_num_rows($result);
                $query = "SELECT * FROM paint_mini_item";
                $query_run = mysqli_query($connection, $query);
            ?>
              <div class="card-body">
