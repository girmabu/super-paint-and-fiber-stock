        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
             ...
             <form class="form-horizontal" action="production_insert.php" method="POST">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">WOVEN</label>
                 <div class="col-sm-10">
                  <input type="double" required name="WOVEN_BALANCE_PCS" required class="form-control" id="WOVEN_BALANCE_PCS" placeholder="Stock in(pcs)">
                 </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Recieved by</label>
                 <div class="col-sm-10">
                  <input type="text"value="<?php echo $_SESSION['name'] ?>" readonly name="RECIVED_BY" required class="form-control">
                 </div>
              </div>
              <div class="form-group row">
            ...
            <div class="card-footer">
             <button type="submit" name="proFiber" class="btn btn-block btn-outline-success btn-lg">Stock In</button>
