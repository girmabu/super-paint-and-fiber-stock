             ...
             <form class="form-horizontal" action="Production_insert.php" method="POST">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Sent </label>
                 <div class="col-sm-10">
                  <input type="text" name="NAME" class="form-control"  placeholder="Sent Person">
                 </div>
              </div>
            <div class="card-footer">
             <button type="submit" name="PAINT" class="btn btn-block btn-outline-success btn-lg">Out</button>
  ...
  <!-- in modal -->
   ...
   <!-- notification modal -->
        <div class="card" style="margin-left:300px">
            <form action="Production_out.php" method="POST" id="out_form">
                <select name="ITEM_ID" id="item">
                    <option value="">ITEM</option>
                    <?php
                    include('connect.php');
                    $query = "SELECT id, ITEM FROM General_Formulation WHERE PREFIX='PRO'";
                ...
                <input type="TEXT" id="out_by"  value="<?php echo $_SESSION['name']; ?>" name="NAME" readonly  required></input>
                ...
                <card-body">
                    ...
                    if (isset($_POST['CHECK'])) {
                        ...
                        FROM profiber_balanceupdated WHERE item_id='$ITEM_ID'";
                        $result1 = $conn->query($query1);
                        $query_run1 = mysqli_query($connection, $query1);
                        $sp_gel = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='1'";
                        $query_run2 = mysqli_query($connection, $sp_gel);
                        $pigment = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='2'";
                        $query_run3 = mysqli_query($connection, $pigment);
                        $n_resin = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='3'";
                        $query_run4 = mysqli_query($connection, $n_resin);
                        $sp_resin = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='4'";
                        $query_run5 = mysqli_query($connection, $sp_resin);
                        $gp_gel = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='5'";
                        $query_run6 = mysqli_query($connection, $gp_gel);
                        $calcium = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='6'";
                        $query_run7 = mysqli_query($connection, $calcium);
                        $hardner = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='7'";
                        $query_run8 = mysqli_query($connection, $hardner);
                        $maj = "SELECT BALANCE,ITEM FROM prochem_balance WHERE ID='8'";
                        $query_run9 = mysqli_query($connection, $maj);
                        // --------------------------VVVVVVVV----------------------------
                        $SP_GEL_SUMMARY = "SELECT * FROM summary  WHERE ID='1'";
                        $query_run12 = mysqli_query($connection, $SP_GEL_SUMMARY);
                        $PIGMENT_SUMMARY = "SELECT * FROM summary  WHERE ID='2'";
                        $query_run13 = mysqli_query($connection, $PIGMENT_SUMMARY);
                        $N_RESIN_SUMMARY = "SELECT * FROM summary  WHERE ID='3'";
                        $query_run14 = mysqli_query($connection, $N_RESIN_SUMMARY);
                        $GP_RESIN_SUMMARY = "SELECT * FROM summary  WHERE ID='4'";
                        $query_run15 = mysqli_query($connection, $GP_RESIN_SUMMARY);
                        $GP_GEL_SUMMARY = "SELECT * FROM summary  WHERE ID='5'";
                        $query_run16 = mysqli_query($connection, $GP_GEL_SUMMARY);
                        $CALCIUM_SUMMARY = "SELECT * FROM summary  WHERE ID='6'";
                        $query_run17 = mysqli_query($connection, $CALCIUM_SUMMARY);
                        $HARDNER_SUMMARY = "SELECT * FROM summary  WHERE ID='7'";
                        $query_run18 = mysqli_query($connection, $HARDNER_SUMMARY);
                        $MAJ_SUMMARY = "SELECT * FROM summary  WHERE ID='8'";
                        ...
                        <table id="datatableid" class="table table-bordered table-gray" margin-left:300px>
                                                                                        ...
                                                                                        foreach ($query_run18 as $row18) {
                                                                                            foreach ($query_run19 as $row19) {
                                                                                                ...
                                                                                                if ($ITEM_ID <= 7) {
                                                                                                    ...
                                                                                                    $w_t_pc = $WBP - $W_OUT;
                                                                                                    $w_400_x_batch = (double)$w_400  *(double) $W_OUT;
                                                                                                ...
                                                                                                if (
                                                                                                    $f_450_x_batch > $fbk || $gp_resin_x_batch > $gprbk || $n_resin_x_batch > $nrbk
                                                                                                    ...
                                                                                                    $gp_resin_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE3' WHERE id='4'";
                                                                                                    ...
                                                                                                    $hbk = $row8['BALANCE'];
                                                                                                    $TOTAL_BALANCE11 = $hbk;
                                                                                                    $hardner_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE11' WHERE id='7'";
                                                                                                    ...
                                                                                                    $pbk = $row3['BALANCE'];
                                                                                                    $TOTAL_BALANCE8 = $pbk;
                                                                                                    $pigment_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE8' WHERE id='2'";
                                                                                                    ...
                                                                                                    $calcium_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE7' WHERE id='6'";
                                                                                                    ...
                                                                                                    $gp_gel_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE6' WHERE id='5'";
                                                                                                    ...
                                                                                                    $spbk = $row2['BALANCE'];
                                                                                                    $TOTAL_BALANCE5 = $spbk;
                                                                                                    $sp_gel_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE5' WHERE id='1'";
                                                                                                    ...
                                                                                                    $nrbk = $row4['BALANCE'];
                                                                                                    $TOTAL_BALANCE4 = $nrbk;
                                                                                                    $n_resin_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE4' WHERE id='3'";
                                                                                                    $query_run12 = mysqli_query($conn, $n_resin_query);
                                                                                                    // --------------------N_RESIN------------------------

                                                                                                    if ($w_400_x_batch > $wbk && $ITEM_ID <= 7) {
                                                                                                        $w_t_pc = 0;
                                                                                                        $W_OUT = 0;
                                                                                                        $TOTAL_BALANCE1 = 0;
                                                                                                        $w_400_query = "UPDATE profiber_balanceupdated SET WOVEN_BALANCE_KG = 
                                                                                                        '$TOTAL_BALANCE1',WOVEN_BALANCE_PCS='$w_t_pc' WHERE ITEM_ID ='$ITEM_ID'";
                                                                                                        $query_run = mysqli_query($conn, $w_400_query);
                                                                                                    } elseif ($w_400_x_batch > $wbk && $ITEM_ID > 7) {
                                                                                                        $w_t_pc = 0;
                                                                                                        $W_OUT = 0;
                                                                                                        $TOTAL_BALANCE1 = $wbk;
                                                                                                        $w_400_query = "UPDATE profiber_balanceupdated SET WOVEN_BALANCE_KG = 
                                                                                                    ...
                                                                                                    $f_450_x_batch <= $fbk || $w_400_x_batch <= $wbk || $gp_resin_x_batch <= $gprbk || $n_resin_x_batch <= $nrbk
                                                                                                    ...
                                                                                                    || $hardner_x_batch <= $hbk
                                                                                                        ...
                                                                                                        $f_t_pc =(double) $FBP -(double)$BATCH;
                                                                                                        $F_OUT = $BATCH;
                                                                                                        $f_450_query = " UPDATE profiber_balanceupdated SET FIBER_BALANCE_KG = '$TOTAL_BALANCE',FIBER_BALANCE_PCS ='$f_t_pc'
                                                                                                                 WHERE ITEM_ID ='$ITEM_ID' ";
                                                                                                        ...
                                                                                                        $n_resin_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE',R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE4'  WHERE id='3'";
                                                                                                        $query_run12 = mysqli_query($conn, $n_resin_query);
                                                                                                        ...
                                                                                                        $n_resin_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE4'  WHERE id='3' AND R_DATE ='$DATE' ";
                                                                                                        ...
                                                                                                        $hbk = $row8['BALANCE'];
                                                                                                        $TOTAL_BALANCE11 = (double) $hbk -(double) $hardner_x_batch;
                                                                                                        $hardner_query = "UPDATE PROCHEM_BALANCE SET BALANCE = '$TOTAL_BALANCE11' WHERE id='7'";
                                                                                                        $query_run1 = mysqli_query($conn, $hardner_query);
                                                                                                        ...
                                                                                                        $hardner_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE11'  WHERE id='7'";
                                                                                                        ...
                                                                                                        $hardner_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE11'  WHERE id='7' AND R_DATE ='$DATE' ";
                                                                                                        ...
                                                                                                        $pigment_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE8'  WHERE id='2'";
                                                                                                        ...
                                                                                                        $pigment_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE8'  WHERE id='2' AND R_DATE ='$DATE' ";
                                                                                                        ...
                                                                                                        $calcium_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE7'  WHERE id='6'";
                                                                                                     ...
                                                                                                     VALUES ('$C_ITEM','$DEPARTMENT' ,'$UOM','$stock_in','$calcium_x_batch', '$TOTAL_BALANCE7', '$NAME','$DATE','$REMARK')";
                                                                                                        ...
                                                                                                        $calcium_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE7'  WHERE id='6' AND R_DATE ='$DATE' ";
                                                                                                        ...
                                                                                                        $gp_gel_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE6'  WHERE id='5'";
                                                                                                        ...
                                                                                                        $gp_gel_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE6'  WHERE id='5' AND R_DATE ='$DATE' ";
                                                                                                        ...
                                                                                                        $sp_gel_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' 
                                                                                                           ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE5'  WHERE id='1'";
                                                                                                        $query_run12 = mysqli_query($conn, $sp_gel_query);
                                                                                                        ...
                                                                                                        $sp_gel_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE5'  WHERE id='1' AND R_DATE ='$DATE' ";
                                                                                                        ...
                                                                                                        $gp_resin_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE'
                                                                                                              ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE3'  WHERE id='4'";
                                                                                                        $query_run1 = mysqli_query($conn, $gp_resin_query);

                                                                                                        $OUT_BALANCE = "INSERT INTO pro_sp_gel_out(ITEM,DEPARTEMENT,UOM,STOCK_IN, STOCK_OUT,P_BALANCE,RECIVED_BY,RECIVED_DATE,REMARK)  
                                                                                                            VALUES ('$GP_RESIN_ITEM','$DEPARTMENT' ,'$UOM','$stock_in','$gp_resin_x_batch', '$TOTAL_BALANCE3', '$NAME','$DATE','$REMARK')";
                                                                                                        $query_run = mysqli_query($conn, $OUT_BALANCE);
                                                                                                        $gp_resin_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE' ,STOCK_IN ='$IN_BALANCE', P_BALANCE = '$TOTAL_BALANCE3'  WHERE id='4' AND R_DATE ='$DATE' ";
                                                                                                        $query_run123 = mysqli_query($conn, $gp_resin_query1);
                                                                                                        $R_DATE_ALL = "SELECT R_DATE FROM dailysummary WHERE DEPARTEMENT='PRO'";
                                                                                                        ...
                                                                                                        if ($DATE!==$RDATE) {
                                                                                                            $daily_summery="SELECT * FROM summary WHERE DEPARTEMENT='PRO'";
                            ...
                            ?>
                                                                                                        <div id="res">
                                                                                                            ...
                                                                                                            ?>
                                                                                                            <div>
                                                                                                                <h6 style="margin-left:20%!important">PRODUCT TYPE: <?php echo $p_item ?> </h6> 
                                                                                                            </div>
                                                                                                            <div>
