            ...
            <form action="Genda_out.php" method="POST" id="out_form">
                ...
                <?php
                            ...
                            if (isset($_POST['CHECK'])) {
                                ...
                                $calcium = "SELECT BALANCE FROM genchem_balance WHERE ID='22'";
                                ...
                                $query_run9 = mysqli_query($connection, $maj);
                                                   ...
                                                   $CALCIUM_SUMMARY = "SELECT * FROM summary  WHERE ID='22'";
                            ...
                            ?>
                                <table id="datatableid" class="table table-bordered table-black">
                                    ...
                                    foreach($query_run19 as $row19){
                                        ...
                                        $pbk = $row3['BALANCE'];
                                        $calcium_x_batch = $row['CALCIUM'] * $BATCH;
                                        $cbk = $row7['BALANCE'];
                                        ...
                                        $cbk=$row7['BALANCE'];
                                        $TOTAL_BALANCE7=$cbk ;
                                        $calcium_query = "UPDATE genchem_balance SET BALANCE = '$TOTAL_BALANCE7' WHERE id='22'";
                                       ...
                                       continue;
                                        ...
                                        $calcium_x_batch = $row['CALCIUM'] * $BATCH;
                                        $cbk = $row7['BALANCE'];
                                        $TOTAL_BALANCE7 = $cbk - $calcium_x_batch;
                                        $calcium_query = "UPDATE genchem_balance SET BALANCE = '$TOTAL_BALANCE7' WHERE id='22'";
                                        $query_run1 = mysqli_query($conn, $calcium_query);
                                        ...
                                        if ($DATE !== $OUT_DATE) {
                                            $OUT_BALANCE = 0;
                                            $IN_BALANCE = 0;
                                            $S_BALANCE = $OUT_BALANCE + $calcium_x_batch;
                                        }
                                        if ($DATE == $OUT_DATE) {
                                            $S_BALANCE = $OUT_BALANCE + $calcium_x_batch;
                                            $IN_BALANCE;
                                        }
                                        $calcium_query = "UPDATE summary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' ,R_DATE='$DATE', P_BALANCE = '$TOTAL_BALANCE7'  WHERE id='22'";
                                     ...
                                     VALUES ('$C_ITEM','$DEPARTMENT' ,'$UOM','$stock_in','$calcium_x_batch', '$TOTAL_BALANCE7', '$NAME','$DATE','$REMARK')";
                                        $query_run = mysqli_query($conn, $OUT_BALANCE);
                                        $calcium_query1 = "UPDATE dailysummary SET STOCK_OUT ='$S_BALANCE',STOCK_IN ='$IN_BALANCE' , P_BALANCE = '$TOTAL_BALANCE7'  WHERE id='22' AND R_DATE ='$DATE' ";
