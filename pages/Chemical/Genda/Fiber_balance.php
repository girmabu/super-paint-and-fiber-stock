...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Genda_history.php" class="nav-link">
        <i class="fa fa-history" aria-hidden="true"> History</i>
        </a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Genda_fiber_summery.php" class="nav-link">
             ...
             <form class="form-horizontal" action="Genda_insert.php" method="POST">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">WOVEN</label>
                 <div class="col-sm-10">
                  <input type="double" readonly value="0" name="WOVEN_BALANCE_PCS" required class="form-control" id="FIBER_BALANCE_PCS" placeholder="Stock in(pcs)">
                 </div>
              </div>
            </div>
  ...
  <div class="modal fade" id="modal-in">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
             ...
             <form class="form-horizontal" action="Genda_insert.php" method="POST">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Recieved by</label>
                 <div class="col-sm-10">
                  <input type="text" readonly value="<?php echo $_SESSION['name']; ?>" required name="RECIVED_BY" class="form-control">
                 </div>
              </div>
            ...
            <div class="card-footer">
             <button type="submit" name="genFiber" class="btn btn-block btn-outline-success btn-lg">Stock In</button>
             <button type="submit"  class="btn btn-block btn-outline-danger btn-sm" data-dismiss="modal">Cancel</button>
            </div>
           </form>
          </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
                ...
                $query = "SELECT * FROM genfiber_balance";
                ...
                <div class="card-body">
                    ...
                    include('connect.php');
                    $ITEM_ID = $row['ITEM_ID'];
                    $query ="SELECT id, ITEM FROM general_formulation WHERE ID =$ITEM_ID";
                    $result = $conn->query($query);
                    if($result->num_rows> 0){
                        while($optionData=$result->fetch_assoc()){
                        $option =$optionData['ITEM'];
