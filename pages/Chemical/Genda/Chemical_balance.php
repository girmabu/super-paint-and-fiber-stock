...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Genda_chem_summery.php" class="nav-link">
        <i class="fas fa-anchor"></i>Summery
        </a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Genda_summery_history.php" class="nav-link">
        <i class="fas fa-anchor"></i>summery History
        </a>
      </li>
    </ul>
    <!-- Right navbar links -->
             ...
             <form class="form-horizontal" action="Genda_insert.php" method="POST">
               ...
               <div class="form-group row"  id="minimal_div">
                <label for="inputEmail3"class="col-sm-2 col-form-label" id="label_div">Product Name</label>
                 <select  name="ITEM_ID" required id="minimal_input" style="width:83% !important">
                  ...
                  <?php
                   include('connect.php');
                    $query = "SELECT id, ITEM FROM GENCHEM_BALANCE";
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">RECIVED_BY</label>
                 <div class="col-sm-10">
                  <input type="text" value="<?php echo $_SESSION['name']; ?>" readonly required name="RECIVED_BY" required class="form-control" >
                 </div>
              </div>
              <div class="form-group row">
            ...
            <div class="modal-body">
             <form action="Genda_insert.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Balance </label>
                            <input type="text" name="balance" id="genda_balance" class="form-control" >
                        </div>
