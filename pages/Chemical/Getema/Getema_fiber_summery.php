...
<head>
  ...
  <title>Getema Fiber Summery</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Getema Fiber Summery</span>
    </a>
    <!-- Sidebar -->
    <div class="sidebar">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Getema Fiber Daily Summery</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php
               ...
               $query = "SELECT * FROM fiber_summary where DEPARTEMENT='GET'";
