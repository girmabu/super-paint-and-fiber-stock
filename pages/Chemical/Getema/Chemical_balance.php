...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Getema_chem_summery.php" class="nav-link">
        <i class="fas fa-anchor"></i>Summery
        </a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Getema_summery_history.php" class="nav-link">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="Getema_out.php" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Getema Out</p>
                    </a>
                  </li>
          ...
          <div class="modal-content">
            <div class="modal-header" style="color:blue">
             ...
             <form class="form-horizontal" action="Getema_insert.php" method="POST">
               ...
               <div class="form-group row"  id="minimal_div">
                <label for="inputEmail3"class="col-sm-2 col-form-label" id="label_div">Product Name</label>
                 <select  name="ITEM_ID" required id="minimal_input" style="width:83% !important">
                  ...
                  <?php
                   include('connect.php');
                    $query = "SELECT id, ITEM FROM GETCHEM_BALANCE";
              ...
              <input type="hidden" value="KG" name="UOM" required class="form-control" id="STOCK_IN" placeholder="Stock in(kg)">
            ...
            <div class="modal-body">
             <form action="Getema_insert.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                        <label> Item </label>
                            <input type="text" name="ITEM" id="item_id" class="form-control" readonly="readonly">
                        </div>
                        <div class="form-group">
                            <label> Uom </label>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php
               ...
               $query = "SELECT * FROM getchem_balance WHERE ID!=14 AND ID!=13 AND ID!=12";
