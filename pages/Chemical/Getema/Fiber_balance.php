...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Getema_history.php" class="nav-link">
        <i class="fa fa-history" aria-hidden="true"> History</i>
        </a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="Getema_fiber_summery.php" class="nav-link">
            ...
            <div class="modal-header" style="color:blue">
             ...
             <form class="form-horizontal" action="Getema_insert.php" method="POST">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">FIBER</label>
                 <div class="col-sm-10">
                  <input type="double" required name="FIBER_BALANCE_PCS" required class="form-control" id="FIBER_BALANCE_PCS" placeholder="Stock in(pcs)">
                 </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">WOVEN</label>
                 <div class="col-sm-10">
                  <input type="double"  name="WOVEN_BALANCE_PCS" required class="form-control" id="FIBER_BALANCE_PCS" placeholder="Stock in(pcs)">
                 </div>
              </div>
            </div>
            <div class="card-footer">
             <button type="submit" name="addfiber"  class="btn btn-block btn-outline-success btn-lg">Stock In</button>
  ...
  <div class="modal fade" id="modal-in">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header" style="color:blue">
             ...
             <form class="form-horizontal" action="Getema_insert.php" method="POST">
              ...
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">Woven</label>
                 <div class="col-sm-10">
                  <input type="double" name="WOVEN_BALANCE_PCS" required class="form-control" id="WOVEN_BALANCE_PCS" placeholder="Stock in(pcs)">
                 </div>
              </div>
              <div class="form-group row">
                <label for="inputPassword3" class="col-sm-2 col-form-label">RECIVED_BY</label>
                 <div class="col-sm-10">
                  <input type="text" readonly value="<?php echo $_SESSION['name']; ?>" name="RECIVED_BY" required class="form-control" >
                 </div>
                    </div>
              <div class="form-group row">
            ...
            <div class="card-footer">
             <button type="submit" name="getFiber" class="btn btn-block btn-outline-success btn-lg">Stock In</button>
             <button type="submit"  class="btn btn-block btn-outline-danger btn-sm" data-dismiss="modal">Cancel</button>
            </div>
           </form>
          </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              <!-- /.card-header -->
                ...
                $query = "SELECT * FROM getfiber_balance";
                ...
                <td> 
                <?php
                if($row['WOVEN_BALANCE_PCS']==0){
                echo "-";
                    }
                else{
                echo $row['WOVEN_BALANCE_PCS']; 
                }             
                ?>   
                </td>
                <td> 
                <?php
                if($row['WOVEN_BALANCE_KG']==0){
                    echo "         -       ";
                }
                else{
                    echo $row['WOVEN_BALANCE_KG']; 
                }
                ?> 
                </td>
