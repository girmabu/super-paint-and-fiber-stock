...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="pro_chem_history.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Chemical Store Transaction History</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <th scope="col"> RECIVED_BY </th>
                  <th scope="col"> RECIVED_DATE </th>
                  </tr>
                  </thead>
                  <?php
                    if ($query_run) {
                    ...
                    include('connect.php');
                    $ITEM_ID = $row['ITEM_ID'];
                    $query = "SELECT ITEM FROM PROCHEM_BALANCE WHERE id =$ITEM_ID";
                    $result = $conn->query($query);
                    $NEW_BALANCE ="SELECT BALANCE FROM ProChem_Balance WHERE id = $ITEM_ID";
                    $result1 = $conn->query($NEW_BALANCE);
